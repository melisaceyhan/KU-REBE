...
{
    const string privateCode = "zZxJO9tQ2U-bSZuPSSWmdA7kVLP3zxuECJcUampGfFxw";  //Key to Upload New Info
    const string publicCode = "64c0f5fe8f40bb8380ddf717";   //Key to download
